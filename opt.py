...
def blit_text_top(win, font, text):
    render = font.render(text, 1, (0, 0, 0))
    win.blit(render, (win.get_width()/2 - render.get_width()/2, win.get_height()/8 - render.get_height()/2))
...
def blit_text_top_left(win, font, text):
    ...
    win.blit(render, (100 - render.get_width() / 2, 100 - render.get_height() / 2))
...
def blit_text_top_right(win, font, text):
    ...
    win.blit(render, (win.get_width() - 100 - render.get_width() / 2, 100 - render.get_height() / 2))
...
def blit_text_bottom_left(win, font, text):
    ...
    win.blit(render, (100 - render.get_width() / 2, win.get_height() - 100 - render.get_height() / 2))
...
def blit_text_bottom_right(win, font, text):
    ...
    win.blit(render, (win.get_width() - 100 - render.get_width() / 2, win.get_height() - 100 - render.get_height() / 2))

def blit_text_player_one_score(win, font, text):
    pygame.font.init()
    render = font.render(text, 1, (0, 0, 0))
    win.blit(render, (300 - render.get_width() / 2, 30 - render.get_height() / 2))

def blit_text_player_two_score(win, font, text):
    pygame.font.init()
    render = font.render(text, 1, (0, 0, 0))
    win.blit(render, (600 - render.get_width() / 2, 30 - render.get_height() / 2))

def blit_timer_text(win, font, text):
    pygame.font.init()
    render = font.render(text, 1, (0, 0, 0))
    win.blit(render, (win.get_width()/2 - render.get_width()/2, win.get_height()/2 - 165 - render.get_height()/2))
